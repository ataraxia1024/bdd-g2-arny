...
users = [
    {"id": 1, "name": "Arny", "lastname": "Salazar", "hermano": "1"},
    {"id": 2, "name": "Stephano", "lastname": "Emir", "hermano": "2"},
    {"id": 3, "name": "Jaasiel", "lastname": "Abigail", "hermano": "3"},
    {"id": 4, "name": "Joctan", "lastname": "Daniel", "hermano": "4"},
    {"id": 5, "name": "Eliel", "hermano": "5"}
]
